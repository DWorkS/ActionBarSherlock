 ...
 * @hide
 */
public class ActionBarViewPlus extends AbsActionBarView {
    ...
    public ActionBarViewPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (mExpandedActionView.getParent() != ActionBarViewPlus.this) {
                addView(mExpandedActionView);
            }
            if (mExpandedHomeLayout.getParent() != ActionBarViewPlus.this) {
