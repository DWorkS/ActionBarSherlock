...
import dev.dworks.libs.widget.Utils.Preconditions;
...
public class ChartGridView extends View {
    ...
    void setBounds(long start, long end) {
        ...
        mLayoutStart = makeLayout(Utils.formatDateRange(context, start, start));
        mLayoutEnd = makeLayout(Utils.formatDateRange(context, end, end));
        invalidate();
    }
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        //FIXME paint.setCompatibilityScaling(res.getCompatibilityInfo().applicationScale);
