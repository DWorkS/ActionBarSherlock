...
import dev.dworks.libs.widget.ChartSweepView.OnSweepListener;
import dev.dworks.libs.widget.Utils.Objects;
...
public class ChartDataUsageView extends ChartView {
    ...
    protected void onFinishInflate() {
        ...
        mSweepWarning.setDragInterval(5 * Utils.MB_IN_BYTES);
        mSweepLimit.setDragInterval(5 * Utils.MB_IN_BYTES);
...
*/
    ...
    private void updateVertAxisBounds(ChartSweepView activeSweep) {
        ...
        final long maxDefault = Math.max(maxVisible, 50 * Utils.MB_IN_BYTES);
    ...
    private long getHistoryStart() {
        return Long.MAX_VALUE;//mHistory != null ? mHistory.getStart() : Long.MAX_VALUE;
    }

    private long getHistoryEnd() {
        return Long.MIN_VALUE; //mHistory != null ? mHistory.getEnd() : Long.MIN_VALUE;
    }
    ...
    public static class DataAxis implements ChartAxis {
        ...
        public long buildLabel(Resources res, SpannableStringBuilder builder, long value) {
            ...
            if (value < 1000 * Utils.MB_IN_BYTES) {
                unit = "MB"; //res.getText(com.android.internal.R.string.megabyteShort);
                unitFactor = Utils.MB_IN_BYTES;
            } else {
                unit = "GB"; //res.getText(com.android.internal.R.string.gigabyteShort);
                unitFactor = Utils.GB_IN_BYTES;
            }
