...
public class ChartNetworkSeriesView extends View {
    ...
    public ChartNetworkSeriesView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int stroke = a.getColor(R.styleable.ChartNetworkSeriesView_strokeColor2, Color.RED);
        final int fill = a.getColor(R.styleable.ChartNetworkSeriesView_fillColor2, Color.RED);
