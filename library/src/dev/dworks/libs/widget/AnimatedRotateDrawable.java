...
public class AnimatedRotateDrawable extends Drawable implements Drawable.Callback, Runnable,
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        final TypedArray a = r.obtainAttributes(attrs, R.styleable.AnimatedRotateDrawableNew);

        //FIXME super.inflateWithAttributes(r, parser, a, R.styleable.AnimatedRotateDrawable_android_visible);
        
        TypedValue tv = a.peekValue(R.styleable.AnimatedRotateDrawableNew_android_pivotX);
        ...
        tv = a.peekValue(R.styleable.AnimatedRotateDrawableNew_android_pivotY);
        ...
        setFramesCount(a.getInt(R.styleable.AnimatedRotateDrawableNew_framesCount, 12));
        setFramesDuration(a.getInt(R.styleable.AnimatedRotateDrawableNew_frameDuration, 150));

        final int res = a.getResourceId(R.styleable.AnimatedRotateDrawableNew_android_drawable, 0);
    ...
    final static class AnimatedRotateState extends Drawable.ConstantState {
        ...
        public AnimatedRotateState(AnimatedRotateState source, AnimatedRotateDrawable owner,
            ...
            if (source != null) {
                ...
                //FIXME mDrawable.setLayoutDirection(source.mDrawable.getLayoutDirection());
